...
public class ProfileActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        faq.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (whatsappInstalledOrNot()) {
                    savecontact();
                    Uri uri = Uri.parse("smsto:" + "+917897318675");
        ...
        call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                callIntent.setData(Uri.parse("tel:+917897318675"));
    ...
    private void sendEmail() {
        ...
        emailIntent.setData(Uri.parse("mailto: singhdigvijay0007@gmail.com"));
    ...
    private void savecontact(){
        ...
        String MobileNumber = "+917897318675";
